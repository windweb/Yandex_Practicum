...
Проекты запускаются в среде _Jupiter Notebook_. Все необходимые для запуска файлы с данными _(.csv)_ расположены в соответствующих папках с проектами. Пути к файлам необходимо скорректировать в зависимости от расположения скачанных файлов _(.csv)_.
