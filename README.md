...
Проекты запускаются в среде _Jupiter Notebook_. Все необходимые для запуска датасеты _(.csv)_ расположены в соответствующих папках с проектами. Пути к датасетам необходимо скорректировать в зависимости от расположения скачанных датасетов  _(.csv)_.
