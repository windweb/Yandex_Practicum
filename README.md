...
## Настроить и запустить среду разработки.
Проекты запускаются в среде Jupiter Notebook. Все необходимые для запуска файлы с данными _(.csv)_ расположены в соответствующих папках с проектами. Пути к файлам необходимо откорректировать в зависимости от расположения файлов _(.csv)_.
